...
// Make sure we only access colorMode.preference after mounting (client-side only)
onMounted(() => {
  console.log(colorMode.preference); // Log to verify when the preference is available on the client
});
